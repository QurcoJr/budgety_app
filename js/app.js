...
var UIController = (function() {
    ...
    return {
        getInput: function() {
            return {            
                type: document.querySelector(DOMstrings.inputType).value, // This will be inc or exp
        ...
        clearFields: function() {
            ...
            fields = document.querySelectorAll(DOMstrings.inputDescription + ', ' + DOMstrings.inputValue); // It's saves as a list
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        // 2. Read the pecentages from the budget controller
